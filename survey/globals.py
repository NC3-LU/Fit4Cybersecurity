...
TRANSLATION_UI = {
    'report': {
        ...
        'request_diagnostic': {
            ...
            'email_body': {
                'en': "Dear Cases Team,\n\nWe would like to request a diagnostic from you.\n\nHere is our evaluation results identifier: {userId}\n\nHere also other information that could be useful: \nLastname of the contact: \nFirstname of the contact: \nEmail address of the contact: \nAddress of the company and Diagnostic place (Luxembourg only): \nDesired for the Diagnostic language: ",
